...
for key in keys_common:
    sakana_score = np.mean(
        [
            main_data_dict[key]['embedding_similarity_q1'],
    ...
    town_score = np.mean(
        [
            data_c_trim_dict[key]['openai_sim_q1'],
...
print(f'Number of common keys: {len(keys_common)}')
print(
    f'Number of openai_sim_sakana_ai_scientist: {len(openai_sim_sakana_ai_scientist)}'
)
...
print(
    f'Average OpenAI Similarity Sakana AI Scientist: {avg_openai_sim_sakana_ai_scientist}'
)
