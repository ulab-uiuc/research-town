...
python compute_metric.py ./results_combine/main_table/research_bench_result_4o_single_agent.jsonl ./results_combine/main_compute/research_bench_result_4o_single_agent.jsonl
