...
if __name__ == "__main__":
    ...
    file1_path = './results/paper_bench_easy_500_result_4o_mini_author_only.jsonl'
    file2_path = './results/paper_bench_easy_500_result_4o_mini_fake_research_town.jsonl'
