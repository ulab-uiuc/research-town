...
def compute_weighted_metric(metrics):
    ...
    return openai_metric, voyageai_metric, bleu, rouge_l
...
if __name__ == "__main__":
    ...
    file1_path = './results/paper_bench_hard_500_result_4o_mini_citation_only.jsonl'
    file2_path = './results/paper_bench_hard_500_result_4o_mini_fake_research_town.jsonl'
    ...
    metric1_openai, metric1_voyageai, metric1_bleu, metric1_rougel = compute_weighted_metric(metrics_file1)
    metric2_openai, metric2_voyageai, metric2_bleu, metric2_rougel = compute_weighted_metric(metrics_file2)
