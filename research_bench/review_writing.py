    ...
    prompt = [
        {
            ...
            'content': (
                ...
                'You should only write about the strengths of the paper.\n'
            ),
        }
    ]
    ...
    prompt = [
        {
            ...
            'content': (
                ...
                f'{intro}\n'
                "Please write a review of the paper based on the introduction and authors' profiles. You should write a paragraph of approximately 200 words.\n"
                'You should only write about the weaknesses of the paper.\n'
            ),
        }
    ]
    response = model_prompting(
    ...
    prompt = [
        {
            ...
            'content': (
                ...
                'Here are the references of the paper:\n'
                f'{ref_strs}\n'
                "Please write a review of the paper based on the introduction, authors' profiles, and references. You should write a paragraph of approximately 200 words.\n"
                'You should only write about the strengths of the paper.\n'
            ),
        }
    ]
