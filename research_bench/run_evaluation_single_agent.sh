...
OUTPUT="./results/research_bench_result_4o_mini_interdisplinary_single_agent.jsonl"
...
while [ "$current_lines" -lt 20 ]; do
  ...
  poetry run python run_evaluation.py --input "$INPUT" --output "$OUTPUT"  $TEST_SINGLE_AGENT
