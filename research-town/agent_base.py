...
class BaseResearchAgent(object):
    ...
    def read_paper(self, external_data: Dict[str, Dict[str, List[str]]],domain:str) -> str:
        time_chunks_embed = {}
        ...
        trend, paper_link = summarize_research_field(self.profile, domain, dataset,
    ...
    def generate_idea(self, external_data: Dict[str, Dict[str, List[str]]],domain:str) -> str:
        time_chunks_embed = {}
        dataset = external_data
        for time in dataset.keys():
            papers = dataset[time]['abstract']
