...
def main():
    ...
    for domain in domain_options:
                        ...
                        idea_data[domain].append(
                            {
                                ...
                                'idea_avg_overall_score': raw_data[
                                    'idea_avg_overall_score'
                                ],
                                'idea_variance_overall_score': raw_data[
                                    'idea_variance_overall_score'
                                ],
                                'idea_sum_variance_dimension_scores': raw_data[
                                    'idea_sum_variance_dimension_scores'
                                ],
                            }
                        )
                        paper_data[domain].append(
                            {
                                ...
                                'agent_model_name': agent_model_name,
                                'evaluator_model_name': evaluator_model_name,
                                'paper_avg_overall_score': raw_data[
                                    'paper_avg_overall_score'
                                ],
                                'paper_variance_overall_score': raw_data[
                                    'paper_variance_overall_score'
                                ],
                                'paper_sum_variance_dimension_scores': raw_data[
                                    'paper_sum_variance_dimension_scores'
                                ],
                            }
                        )
                        review_data[domain].append(
                            {
                                ...
                                'agent_model_name': agent_model_name,
                                'evaluator_model_name': evaluator_model_name,
                                'review_avg_overall_score': raw_data[
                                    'review_avg_overall_score'
                                ],
                                'review_variance_overall_score': raw_data[
                                    'review_variance_overall_score'
                                ],
                                'review_sum_variance_dimension_scores': raw_data[
                                    'review_sum_variance_dimension_scores'
                                ],
                            }
                        )
        ...
        parsed_idea_file_path = os.path.join(
            data_path,
            'eval_data',
            'pipeline_eval_data',
            'parsed_output',
            parsed_idea_file_name,
        )
        parsed_paper_file_path = os.path.join(
            data_path,
            'eval_data',
            'pipeline_eval_data',
            'parsed_output',
            parsed_paper_file_name,
        )
        parsed_review_file_path = os.path.join(
            data_path,
            'eval_data',
            'pipeline_eval_data',
            'parsed_output',
            parsed_review_file_name,
        )
