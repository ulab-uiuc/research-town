...
def summarize_research_field_prompting(
    ...
    model_name: Optional[str] = 'together_ai/togethercomputer/llama-2-7b',
) -> List[str]:
    """
...
def find_collaborators_prompting(input: Dict[str, str], self_profile: Dict[str, str], collaborator_profiles: Dict[str, str], parameter: float = 0.5, max_number: int = 3,  model_name: Optional[str] = 'together_ai/togethercomputer/llama-2-7b',) -> List[str]:
    self_serialize = [
...
def review_score_prompting(paper_review: str, model_name: Optional[str] = 'together_ai/togethercomputer/llama-2-7b') -> int:
    prompt_qa = (
...
def review_paper_prompting(paper: Dict[str, str],  model_name: Optional[str] = 'together_ai/togethercomputer/llama-2-7b') -> List[str]:
    """
...
def make_review_decision_prompting(paper: Dict[str, str], review: Dict[str, Tuple[int, str]], model_name: Optional[str] = 'together_ai/togethercomputer/llama-2-7b') -> List[str]:
    paper_serialize = []
    for _, title in enumerate(paper.keys()):
...
def rebut_review_prompting(paper: Dict[str, str], review: Dict[str, Tuple[int, str]], decision: Dict[str, Tuple[bool, str]], model_name: Optional[str] = 'together_ai/togethercomputer/llama-2-7b') -> List[str]:
